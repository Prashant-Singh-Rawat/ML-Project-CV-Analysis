...
COMPANY_REQUIREMENTS = {
    ...
    "Amazon": {
        "min_cgpa": 8.0,
        "required_skills": ["Java", "AWS", "SQL", "Leadership", "Scalability"],
    },
    "Microsoft": {
        "min_cgpa": 8.0,
        "required_skills": ["C++", "C#", "Azure", "Cloud", "Software Design"],
    },
    "Meta": {
        "min_cgpa": 8.2,
        "required_skills": [
    ...
    "Infosys": {
        "min_cgpa": 6.5,
        "required_skills": ["Java", "SQL", "Communication", "Web Development"],
    },
    "TCS": {
        "min_cgpa": 6.5,
        "required_skills": ["Java", "JavaScript", "SQL", "Enterprise Solutions"],
    },
    "Oracle": {
        "min_cgpa": 7.5,
        "required_skills": ["Java", "SQL", "Database Design", "Cloud Architecture"],
    },
    "IBM": {
        "min_cgpa": 7.0,
        "required_skills": ["Python", "AI", "Cloud", "Data Science"],
    },
...
def generate_synthetic_data(num_samples=10000):
    ...
    for _ in range(num_samples):
        ...
        if is_good_candidate:
            ...
            target_skills = set(
                COMPANY_REQUIREMENTS.get(company, {}).get("required_skills", [])
            )
            candidate_skills = list(target_skills) + random.sample(
                SKILLS_DB, max(0, num_skills - len(target_skills))
            )
        else:
